...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Friendship relationship response containing all details about a friend request or friendship")
public class FriendshipResponse {
    ...
    public static FriendshipResponse fromDomain(Friendship friendship) {
