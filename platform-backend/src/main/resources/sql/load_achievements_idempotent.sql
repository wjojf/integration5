-- ============================================================================
-- Achievements Loading Script for Connect Four and Chess (Idempotent Version)
-- ============================================================================
-- This script loads achievements for both Connect Four and Chess games
-- Uses ON CONFLICT to make it safe to run multiple times
-- 
-- Game IDs:
...
-- Summary
-- ============================================================================
-- Connect Four: 15 achievements
-- Chess: 18 achievements
